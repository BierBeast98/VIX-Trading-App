  ...
  return (
    <div className="p-4 lg:p-6 space-y-4 lg:space-y-6 animate-pulse">
      <div className="flex items-center justify-between">
        <div>
          <div className="h-7 w-32 rounded-lg" style={{ background: "#1E1E28" }} />
          <div className="h-4 w-48 rounded mt-1.5" style={{ background: "#1E1E28" }} />
        </div>
      ...
      <div className="rounded-xl border p-5" style={{ background: "#141418", borderColor: "#1E1E28" }}>
        ...
        <div className="h-[280px] rounded-lg" style={{ background: "#1E1E28" }} />
      </div>
    </div>
  );
}
